export default function tahsin(inputText) {
    ...
    if (inputText) {
        let processedText = inputText
            ...
            .replace(/ص[ًٌٍَُِّْ]*ل[ًٌٍَُِّْ]*ى[ًٌٍَُِّْ]*\s+ا[ًٌٍَُِّْ]*ل[ًٌٍَُِّْ]*ل[ًٌٍَُِّْ]*ه[ًٌٍَُِّْ]*\s+ع[ًٌٍَُِّْ]*ل[ًٌٍَُِّْ]*ي[ًٌٍَُِّْ]*ه[ًٌٍَُِّْ]*\s+و[ًٌٍَُِّْ]*س[ًٌٍَُِّْ]*ل[ًٌٍَُِّْ]*م[ًٌٍَُِّْ]*/g, 'ﷺ')
